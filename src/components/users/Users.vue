      ...
      <el-table :data="userlist" border stripe style="width: 100%">
        ...
        <el-table-column label="状态">
          <template slot-scope="scope">
            <el-switch v-model="scope.row.mg_state" @change="suerStateChanged(scope.row)"></el-switch>
          </template>
        </el-table-column>
...
<!--    分配角色-->
    <el-dialog
      ...
      <p>分配新角色：
        <el-select v-model="selectRoleId" placeholder="请选择" clearable>
          <el-option
  ...
  export default {
    ...
    methods: {
      async getUserList() {
        ...
        // this.$message({message: '获取用户列表成功！', type: 'warning'})
      ...
      async suerStateChanged(userinfo) {
